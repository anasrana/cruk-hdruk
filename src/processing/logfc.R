...
t47d_file <- "data/T47D/Gene/count_matrix.csv"
...
# for (){
#  print(gene)
#  tmp_res <- results(dds, pAdjustMethod = "BH", contrast = c("group", gene, "CTRL"))
#  resOrdered <- tmp_res[order(tmp_res$pvalue),]
#  write.csv(as.data.frame(resOrdered), file=paste0(out_dir, gsub(" ", "_", gene), "_results_DESeq.csv"))
# }
