...
def calc_spearman(data, gene, gene_list):
    # calculation pairwise spearman correlations for a list of genes 
    ...
    pkl.dump(spearman, open(f"../../TransformedData_DerivedData/correlation_network/corr_coeff_spearman_{gene}_KO.pkl", "wb"))
...
if __name__ == "__main__":
    ...
    large_genes = []
    for g in genes:
        data = pd.read_csv(f"../../TransformedData_DerivedData/DE_DESeq/CTRL_vs_{g}_results_DESeq.csv", index_col=0)
